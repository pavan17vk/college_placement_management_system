...
<body>
				<div class="list-unstyled3" >
					<ul>
						<li><img src="dbi.jpg" alt="DBIT Kumbalagoodu"  class="logo2" height="55"  align="left"/></li>
					    <li style="float:right"><a  href="dbi.php"><img src="dbi.jpg" alt="DBIT Kumbalagoodu"   height="24"   /></a></li>
					  <div class="para">
